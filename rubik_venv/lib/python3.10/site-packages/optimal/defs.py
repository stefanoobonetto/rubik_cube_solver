...
N_SLICE_SORTED = 11880  # 12*11*10*9 possible positions of the FR, FL, BL, BR edges
N_SLICE = N_SLICE_SORTED // N_PERM_4  # we ignore the permutation of the edges FR, FL, BL, BR
